...
function ProductList() {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // To track disabled buttons
    ...
    const plantsArray = [
        {
            ...
            plants: [
                ...
                { name: "Peace Lily", image: "url...", cost: "$18" },
                { name: "Boston Fern", image: "url...", cost: "$20" },
                { name: "Rubber Plant", image: "url...", cost: "$17" },
                { name: "Aloe Vera", image: "url...", cost: "$10" }
            ]
        },
        // ... (Add 2 more categories with 6 plants each here)
    ];
        ...
        <div>
            ...
            <div className="navbar">
                ...
                <div style={{display:'flex', gap: '30px'}}>
                    <a href="#" onClick={(e)=>handlePlantsClick(e)} style={{color:'white', fontSize:'30px'}}>Plants</a>
